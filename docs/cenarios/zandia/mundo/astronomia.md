...
<thead>
    <tr>
    <th colspan="2">Resumo do Sistema Astronômico de Zandria</th>
    </tr>
</thead>
<tbody>
    <tr>
    <td><strong>Estrela</strong></td>
    <td>Anã amarela (classe G)</td>
    </tr>
    <tr>
    <td><strong>Distância orbital</strong></td>
    <td>~0,96 UA</td>
    </tr>
    <tr>
    ...
    <tr>
    <td><strong>Diâmetro do planeta</strong></td>
    <td>10.700 km</td>
    </tr>
    <tr>
    ...
    <tr>
    <td><strong>Lua maior</strong></td>
    <td>Prateada, semelhante à Lua terrestre (Elaris)</td>
    </tr>
    <tr>
    <td><strong>Lua menor</strong></td>
    <td>Alaranjada-avermelhada, rica em óxidos de ferro (Vaelith, a Lua de Sangue)</td>
    </tr>
    <tr>
    <td><strong>Inclinação do eixo</strong></td>
    <td>21°</td>
    </tr>
</tbody>
</table>