...
<img src="/assets/imagens/syridiano.png" style="width:50%;">
...
**Modificadores de atributos**: ST+2, IQ-1, HT+1, <span title="PV: Pontos de Vida">HP</span>+4 <span title="MT: Modificador de tamanho">SM</span>+1

**Vantagens raciais:**

- <span title="Reflexos em combate">Combat Reflexes</span>
- <span title="Resistência a dano (Pele rígida)">Damage Resistance (Tough Skin)</span>+2
- <span title="Membrana Nictante">Nictating Membrane</span>+2
- <span title="Visão Periférica">Peripheral Vision</span>
...
- <span title="Escamas">Scales</span>

**Desvantagens raciais:**

- <span title="Irritadiço">Bad Temper</span> (CR12)
- <span title="Sangue Frio">Cold-Blooded</span>
- <span title="Baixo NT">Low TL</span>-1
- <span title="Covardia">Social Stigma: Savage</span> (CR12)
- <span title="Estigma Social: Selvagem">Social Stigma: Minority Gtoup</span>


**Pecurialidades (Quirks) raciais:**

- <span title="Pragmático">Pragmatic</span>

#### **Print do GCS:**

![dwarf_gcs](../../../assets/imagens/syridiano_gcs.png)
