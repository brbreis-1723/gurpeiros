...
<img src="/assets/imagens/clopas.png" style="width:50%;">
...
**Modificadores de atributos**: Per+1, <span title="Velocidade básica">Basic Speed</span>+0.25

**Vantagens raciais:**

- <span title="Visão aguçada">Acute Vision</span>+3
- <span title="Noção do Perigo">Danger Sense</span>
- <span title="Infravisão">Infravision</span>
- <span title="Aptidão Mágica (Sensibilidade à magia)">Magery 0</span>
- <span title="Reconhecimento Social (Venerado: Oráculo)">Social Regard (Venerated: Oracle)</span>+1

**Qualidades (Perks) raciais:**

- <span title="Dom Mágico (Adivinhação:Oneiromancia)">Charm (Divination: Oneiromancy)</span>

**Desvantagens raciais:**

- <span title="Timidez Suave">Mild Shyness</span>(CR 12)
- <span title="Zarolho">One Eye</span>


**Pecurialidades (Quirks) raciais:**

- <span title="Disciplinado">Disciplined</span>
...
![dwarf_gcs](../../../assets/imagens/clopas_gcs.png)
